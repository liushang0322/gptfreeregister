        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              localCpaJsonPluginDir: prevState.localCpaJsonPluginDir,
              localCpaJsonRelativeAuthDir: prevState.localCpaJsonRelativeAuthDir,
              localCpaStep9Mode: prevState.localCpaStep9Mode,
              sub2apiUrl: prevState.sub2apiUrl,
              sub2apiEmail: prevState.sub2apiEmail,
              sub2apiPassword: prevState.sub2apiPassword,
              sub2apiGroupName: prevState.sub2apiGroupName,
              sub2apiGroupNames: prevState.sub2apiGroupNames,
              sub2apiAccountPriority: prevState.sub2apiAccountPriority,
              sub2apiDefaultProxyName: prevState.sub2apiDefaultProxyName,
              codex2apiUrl: prevState.codex2apiUrl,
